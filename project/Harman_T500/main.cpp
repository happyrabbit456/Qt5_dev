...
//caijx
static int   PrimaryAddress = 22;// 2;      /* Primary address of the device           */
static int   SecondaryAddress = 0;    /* Secondary address of the device         */
static char  Buffer[101];             /* Read buffer                             */
